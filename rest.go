...
type Request struct {
	Method Method
	BaseURL string // e.g. https://api.google.com
...
// Error is the implmentation of the error interface.
...
// BuildRequestObject creaters the HTTP request object.
...
// Depcrecated: API supports old implementation
...
// SendWithContext uses the DefaultClient to send yout request with the provided context.
